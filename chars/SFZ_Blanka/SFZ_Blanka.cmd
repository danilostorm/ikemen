...
trigger1 = Command = "S_Elect"

; Super Rolling attack
[State -1]
type = ChangeState
value = 3020
triggerall = StateType != A
...
triggerall = Power >= 3000
trigger1 = (Command = "TH_c") && (Ctrl = 1 || StateNo = 40)
...
triggerall = MoveType != H
triggerall = Power >= 2000
trigger1 = (Command = "TH_b") && (Ctrl = 1 || StateNo = 40)
...
trigger2 = EnemyNear, NumProj != 0 && Time > 50
...
type = ChangeState
value = 3200
triggerall = var(59) && AILevel > 5 && roundstate = 2
triggerall = statetype != A
...
triggerall = statetype != A
trigger1 = ctrl
trigger1 = p2statetype = L && p2bodydist x > 100
...
triggerall = statetype != A
trigger1 = ctrl
trigger1 = random < 100 && p2life < 700
...
type = ChangeState
value = 235
triggerall = random < var(59)*100 && AILevel > 2 && roundstate = 2 && teammode = single
triggerall = statetype != A
...
trigger1 = p2stateno = [10,153] && p2statetype != C
