...
triggerall = NumProj = 0
trigger1 = statetype != A && ctrl 
trigger1 = p2bodydist X > 120 && p2stateno = 5101 || p2statetype != L && p2movetype != A && p2bodydist X > 140 && random < var(55)*2
trigger2 = Movehit = 1
...
type = ChangeState
value = 215
triggerall = var(55) > 2 && AILevel > 3 && roundstate = 2
triggerall = p2statetype != A
