...
;type=changestate
;value=120
;triggerall= AIlevel>=1; && random<500
...
type=changestate
value=195
triggerall= AIlevel>=1 && roundstate=2 && statetype!=A
...
type = ChangeState
value = 720
triggerall= AIlevel>=1 && numenemy && !var(57)
...
type = changestate
value = 750
trigger1 = AIlevel>=3 && numenemy && power < 3000
...
triggerall= AIlevel>=1 && roundstate=2 && statetype!=A && ctrl; && random<50
...
triggerall= AIlevel>=1 && roundstate=2 && statetype=S && stateno!=100 && (ctrl || stateno=21)
...
type=changestate
value=4100
triggerall= AIlevel>=7 && roundstate=2 && statetype!=A && power >= 3000
...
triggerall= AIlevel>=7 && roundstate=2 && statetype!=A && power >= 2000
triggerall= ceil(enemynear, stateno!=[120,155]) && (p2statetype!=L) && enemynear, ctrl = 0
...
triggerall= AIlevel>=6 && roundstate=2 && statetype!=A && power >= 1000 && power < ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && partner, name != "Akuma" && partner, authorname != "Mr.Ansatsuken" && (Partner, Time >= 9), powermax*2, 3000)
triggerall= ceil(enemynear, stateno!=[120,155]) && (p2statetype!=L) && enemynear, ctrl = 0
...
type=changestate
value=3000
triggerall= AIlevel>=6 && roundstate=2 && statetype!=A && power >= 1000 && power < 2000
triggerall= ceil(enemynear, stateno!=[120,155]) && (p2statetype!=L) && enemynear, ctrl = 0
triggerall= (p2bodydist x=[0,110]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
triggerall= (p2stateno!=[1100,1105])
trigger1= stateno=1000 && (movehit=[1,4]) && random<50 && enemynear, movetype = H
...
type=changestate
value=1100
triggerall= AIlevel>=3 && numenemy && life > 50
triggerall= roundstate=2 && statetype!=A
...
type=changestate
value=1110
triggerall= AIlevel>=4 && numenemy && life > 50 && power >= 500 && power < 3000
triggerall= roundstate=2 && statetype!=A
triggerall= (p2bodydist x=[0,72]) && inguarddist && !var(26)
triggerall= p2statetype!=A && p2statetype!=L
triggerall= (enemynear,stateno=[200,999]) || (enemynear,hitdefattr=SCA,NA)
trigger1= (ctrl || stateno=52 || stateno=21 || (stateno=[100,101])) && random<125
;---------------------------------------------------------------------------
;Light Back Swing Blow
[State -1, Light Back Swing Blow]
type=changestate
value=1200
triggerall= AIlevel>=4 && roundstate=2 && statetype!=A && stateno!=[1200,1225]
...
type=changestate
value=1220
triggerall= AIlevel>=3 && roundstate=2 && statetype!=A && stateno!=[1200,1225]
...
type = ChangeState
value = 1060
triggerall= AIlevel>=3 && roundstate=2 && statetype!=A
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x>0) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= ctrl && p2bodydist x<50 && random<200
trigger2= (stateno=[220,225]) && movehit && p2bodydist x<20 && random<75
...
type = ChangeState
value = 1080
triggerall= AIlevel>=4 && roundstate=2 && statetype!=A && power >= 500 && power < 3000
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x>0) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
...
type=changestate
value=1010
triggerall= AIlevel>=4 && roundstate=2 && statetype!=A
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
...
type=changestate
value=1030
triggerall= AIlevel>=1 && roundstate=2 && statetype!=A && power >= 500 && power < 3000
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
...
type=changestate
value=100
trigger1= AIlevel>=1 && statetype=S && roundstate=2 && (ctrl || stateno=21) && random<200
...
trigger1= enemynear,hitdefattr=SC,ST,HT && random<100*(AIlevel**2/64.0)
...
trigger2= !(enemynear,statetype=A) && random<100*(AIlevel**2/64.0)
...
type=changestate
value=200
triggerall= AIlevel>=3 && statetype!=A && roundstate=2
triggerall= (p2bodydist x=[0,58]) && (p2bodydist y=[-50,50]) && p2statetype!=L
trigger1= (ctrl || stateno=21) && random<300
...
trigger1= (ctrl || stateno=21) && random<75
...
trigger1= (ctrl || stateno=21) && random<100
...
type=changestate
value=230
triggerall= AIlevel>=1 && statetype!=A && roundstate=2
...
trigger1= (ctrl || stateno=21) && random<33
trigger2= (stateno=[200,205]) && movehit && random<500
trigger3= (stateno=[230,235]) && movehit && random<500
trigger4 = stateno = 100 && random<300
;-----------------------------------------------------------------------------
...
trigger1= (ctrl || stateno=21) && random<50
trigger2 = stateno = 100 && time > 2
;------------------------------------------------------------------------
[State -1, CMP]
type=changestate
...
triggerall= (p2bodydist x=[0,70]) && (p2bodydist y=[-50,50]) && !(enemynear,statetype=L) && !(enemynear,hitfall)
trigger1= ctrl && enemynear,statetype=A && vel y<=2 && random<200*(AILevel**2/64.0)
...
trigger1= p2bodydist x>=20 && (p2dist y=[-60,80]) && random<550*(AILevel**2/64.0)
trigger2= ctrl && enemynear,statetype=A && vel y<=2 && random<400*(AILevel**2/64.0)
