...
triggerall = !var(59)
triggerall = ctrl = 1
trigger1 = command = "superknuckle3"
; Super Spinning Knuckle2
[State -1]
type = ChangeState
value = 11540
triggerall = power >= 2000
...
triggerall = !var(59)
triggerall = ctrl = 1
trigger1 = command = "superknuckle2"
; Super Spinning Knuckle
[State -1]
type = ChangeState
value = 1540
triggerall = power >= 1000
...
triggerall = !var(59)
triggerall = ctrl = 1
trigger1 = command = "superknuckle1"
...
trigger1 = ctrl 
trigger1 = random <= 999
trigger1 = Enemynear, NumProj = 1 && Time > 50
...
trigger2 = p2stateno = 22 || p2stateno = 42
