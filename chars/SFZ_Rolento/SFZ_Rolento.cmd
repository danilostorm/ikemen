;--------------------------------------------------------------------------
; ROLENTO's AIR file by Tenshin (fairpear@hotmail.com)
;   downloaded from OpenMugen @ "http://kickme.to/openmugen"
;--------------------------------------------------------------------------
;=====================================================================
;-| AI section |------------------------------------------------------
;---------------------------------------------------------------------
...
; Super Combos
;==========================================================================
[State -1, Steel Rain S]
type = ChangeState
value = 3220
triggerall = command = "SteelRain_c"
...
[State -1, Steel Rain M]
type = ChangeState
value = 3210
triggerall = command = "SteelRain_b"
...
trigger6 = Stateno = 400 && MoveContact
trigger7 = Stateno = 430 && MoveContact
[State -1, Steel Rain W]
type = ChangeState
value = 3200
triggerall = command = "SteelRain_a"
...
[State -1, Mine Sweeper S]
type = ChangeState
value = 3120
triggerall = command = "mine_z"
triggerall = power >= 3000
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
...
[State -1, Mine Sweeper M]
type = ChangeState
value = 3110
triggerall = command = "mine_y"
triggerall = power >= 2000
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
...
trigger7 = Stateno = 430 && MoveContact
trigger8 = Stateno = 440 && MoveContact
[State -1, Mine Sweeper W]
type = ChangeState
value = 3100
triggerall = command = "mine_x"
triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
...
[State -1, Take No Prisoners S]
type = ChangeState
value = 3020
triggerall = command = "TNPz"
triggerall = power >= 3000
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
...
trigger7 = Stateno = 430 && MoveContact
trigger8 = Stateno = 440 && MoveContact
[State -1, Take No Prisoners M]
type = ChangeState
value = 3010
triggerall = command = "TNPy"
triggerall = power >= 2000
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
...
trigger7 = Stateno = 430 && MoveContact
trigger8 = Stateno = 440 && MoveContact
[State -1, Take No Prisoners W]
type = ChangeState
value = 3000
triggerall = command = "TNPx"
triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
...
; Special Moves
;==========================================================================
[State -1, Patriotic SFZ 3 Type 2]
type = ChangeState
value = 1500
...
[State -1, Patriotic SFZ 3 Type 1]
type = ChangeState
value = 1450
...
[State -1, Mekong Delta Air Raid W]
type = ChangeState
value = 1100
...
[State -1, Mekong Delta Air Raid M]
type = ChangeState
value = 1101
...
[State -1, Mekong Delta Air Raid S]
type = ChangeState
value = 1102
...
type = ChangeState
value = 1000
triggerall = command = "STINGER_a" && statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
trigger3 = Stateno = 225 && MoveContact
trigger4 = Stateno = 230 && MoveContact
...
type = ChangeState
value = 1010
triggerall = command = "STINGER_b" && statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
trigger3 = Stateno = 225 && MoveContact
trigger4 = Stateno = 230 && MoveContact
...
type = ChangeState
value = 1020
triggerall = command = "STINGER_c" && statetype != A
trigger1 = ctrl = 1
trigger2 = Stateno = 200 && MoveContact
trigger3 = Stateno = 225 && MoveContact
trigger4 = Stateno = 230 && MoveContact
...
trigger1 = ctrl = 1
trigger2 = stateno = 40
trigger3 = var(10) && hitdefattr = SC, NA && movehit = 1
...
trigger1 = stateno = 1021 && Animtime = 0
trigger2 = stateno = 1001 && Animtime = 0
trigger3 = stateno = 1011 && Animtime = 0
[State -1]
type = ChangeState
value = 1031
triggerall = var(59)
...
value = 1510
triggerall = var(59)
trigger1 = stateno = 1500 && Animtime = -5
...
value = 1520
triggerall = var(59)
trigger1 = stateno = 1510 && Animtime = -5
triggerall = movecontact
...
value = 3220
triggerall = Power >= 3000
triggerall = random < var(59)*20 && AILevel > 5
triggerall = statetype != A
trigger1 = ctrl
...
value = 3210
triggerall = Power >= 2000
triggerall = random < var(59)*100 && AILevel > 3
...
trigger1 = p2stateno = 430 || p2stateno = 440 || p2stateno = 450
[State -1]
type = ChangeState
value = 3000
triggerall = Power >= 1000
...
trigger2 = stateno = 1300 && p2bodydist X = [30,70]
[State -1]
type = ChangeState
value = 610
triggerall = random < var(59)*100 && roundstate = 2
