...
triggerall = (StateNo = [150,153]) && Var(31) != -1
trigger1 = Power >= 1000
triggerall = statetype != A
ignorhitpause = 1
...
trigger1 = random <= 20
trigger2 = p2movetype = A || EnemyNear,NumProj
...
trigger1 = random <= 60
trigger2 = p2stateno = [1000,1999] && p2movetype = A
...
type = ChangeState
value = 800
triggerall = random < var(59)*10 && AILevel > 3 && roundstate = 2 && teammode = single
triggerall = statetype != A
trigger1 = ctrl
