...
main.t_itemname = {
	...
	['survival'] = function()
		...
		main.numTag = {2, math.min(2, config.Players)}
		main.matchWins.draw = {0, 0}
		main.matchWins.simul = {1, 1}
		main.matchWins.single = {1, 1}
		main.matchWins.tag = {1, 1}
			...
			if main.menu.f ~= nil and not main.fadeActive then
				...
				elseif main.f_input(main.t_players, main.f_extractKeys(motif[main.group].menu_accept_key)) then
					...
					if f == 'back' then
						...
						break
					elseif f == 'exit' then
						os.exit() --EDIT: "QUIT" command quits the game, instead of going back to attract mode
						break
...
--hiscore rendering
main.t_hiscoreData = {
	arcade = {mode = 'arcade', data = 'score', title = motif.select_info.title_teamarcade_text},
