...
-- GEN ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_DJ", "SFZ_Sagat", "SFZ_Ken", "SFZ_Sakura", "SFZ_Birdie", "SFZ_Guy", "SFZ_Adon", "SFZ_Sodom-X", "SFZ_KBee", "SFZ_Rolento"}
    local match5characters = {"SFZ_ChunLi-Z"}
	local match6characters = {"SFZ_Dan", "SFZ_Birdie", "SFZ_Charlie"}
    local match7characters = {"SFZ_Zangief", "SFZ_FeiLong", "SFZ_Mike"}
    local match8characters = {"SFZ_Dhalsim"}	
	local match9characters = {"SFZ_E-Ryu"}
	local match10characters = {"SFZ_Akuma"}

	launchStoryboard('data/Intros/Intro_GenX.def')
	launchStoryboard('data/Intros/Intro_GenX2.def')
...
if matchno() == 10 then
    ...
    local ok = launchFight{
        ...
        p2numchars = 1,
        p2teammode = "single",
		stage = "stages/_Boss-Gokuento.def"
    }
