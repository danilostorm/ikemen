--------------------------------------------
-- NO CAPE BISON ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Ken", "SFZ_Sagat", "SFZ_Akuma", "SFZ_Zangief", "SFZ_Adon", "SFZ_Guy", "SFZ_Dhalsim", "SFZ_Sakura"}
    local match5characters = {"SFZ_R-Charlie"}
	local match6characters = {"SFZ_ChunLi-X"}
    local match7characters = {"SFZ_Cammy"}
    local match8characters = {"SFZ_Rose"}	
	local match9characters = {"SFZ_Guile"}
	local match10characters = {"SFZ_Ryu"}

	launchStoryboard('data/Intros/Intro_N-Bison.def')
	launchStoryboard('data/Intros/Intro_N-Bison2.def')
...
if matchno() == 5 then
    ...
    local ok = launchFight{
        ...
        p2numchars = 1,
        p2teammode = "single",
		stage = "stages/_Boss-Charlie2.def"
    }
