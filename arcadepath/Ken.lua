...
-- KEN ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Charlie", "SFZ_Birdie", "SFZ_Rolento", "SFZ_Sakura", "SFZ_Rose", "SFZ_ChunLi-Z", "SFZ_Dan"}
    local match5characters = {"SFZ_Karin"}
	local match6characters = {"SFZ_Akuma", "SFZ_Gen-Z", "SFZ_Sodom-Z", "SFZ_Guy"}
    local match7characters = {"SFZ_Dhalsim", "SFZ_Adon", "SFZ_Zangief"}
    local match8characters = {"SFZ_Sagat"}	
	local match9characters = {"SFZ_Bison"}
	local match10characters = {"SFZ_Ryu"}

	launchStoryboard('data/Intros/Intro_Ken.def')
	launchStoryboard('data/Intros/Intro_Ken2.def')
