...
-- RYU ARCADE PATH
--------------------------------------------
	local match1234characters = {"SFZ_Dan", "SFZ_ChunLi-Z", "SFZ_Birdie", "SFZ_Dhalsim", "SFZ_Charlie", "SFZ_Guy", "SFZ_Gen-Z"}
    local match5characters = {"SFZ_Rose"}
	local match6characters = {"SFZ_Adon", "SFZ_Sakura", "SFZ_Rolento",  "SFZ_Zangief"}
    local match7characters = {"SFZ_Ken"}
    local match8characters = {"SFZ_Sagat"}	
	local match9characters = {"SFZ_Bison"}
	local match10characters = {"SFZ_Akuma"}
	
	launchStoryboard('data/Intros/Intro_Ryu.def')	
	launchStoryboard('data/Intros/Intro_Ryu2.def')	
