...
-- ROSE ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Sakura", "SFZ_Gen-Z", "SFZ_Charlie", "SFZ_Adon", "SFZ_Sodom-Z", "SFZ_Birdie", "SFZ_Dan", "SFZ_Zangief"}
    local match5characters = {"SFZ_Akuma"}
	local match6characters = {"SFZ_Guy", "SFZ_Rolento", "SFZ_ChunLi-Z"}
    local match7characters = {"SFZ_Ryu", "SFZ_Ken"}
    local match8characters = {"SFZ_Dhalsim"}	
	local match9characters = {"SFZ_Sagat"}
	local match10characters = {"SFZ_Bison"}

	launchStoryboard('data/Intros/Intro_Rose.def')
	launchStoryboard('data/Intros/Intro_Rose2.def')
