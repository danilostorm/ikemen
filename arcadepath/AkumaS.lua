--------------------------------------------
-- SHIN AKUMA ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Birdie", "SFZ_Charlie", "SFZ_Dan", "SFZ_Rolento", "SFZ_Zangief", "SFZ_ChunLi-Z", "SFZ_Sagat", "SFZ_Sakura"}
    local match5characters = {"SFZ_Gen-X"}
	local match6characters = {"SFZ_Rose", "SFZ_Guy", "SFZ_Dhalsim", "SFZ_Sodom-Z"}
    local match7characters = {"SFZ_Ryu"}
    local match8characters = {"SFZ_D-Sakura"}	
	local match9characters = {"SFZ_V-Ken"}
	local match10characters = {"SFZ_N-Bison"}

	launchStoryboard('data/Intros/Intro_ShinAkuma.def')
	launchStoryboard('data/Intros/Intro_ShinAkuma2.def')
