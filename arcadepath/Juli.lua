--------------------------------------------
-- KILLER BEE ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Dan", "SFZ_Karin", "SFZ_Mika", "SFZ_Rolento", "SFZ_Zangief", "SFZ_FeiLong", "SFZ_Sodom-X", "SFZ_Blanka"}
    local match5characters = {"SFZ_Vega"}
	local match6characters = {"SFZ_Guile", "SFZ_Charlie", "SFZ_Rose", "SFZ_Ken"}
    local match7characters = {"SFZ_Gen-X", "SFZ_DJ", "SFZ_Honda"}
    local match8characters = {"SFZ_ChunLi-X"}	
	local match9characters = {"SFZ_Birdie"}
	local match10characters = {"SFZ_Cammy"}

	launchStoryboard('data/Intros/Intro_Juli.def')
	launchStoryboard('data/Intros/Intro_Juli2.def')
