...
-- CAMMY ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Ryu", "SFZ_Karin", "SFZ_Mika", "SFZ_Guy", "SFZ_Sagat", "SFZ_Gen-X", "SFZ_Sodom-X", "SFZ_Blanka"}
    local match5characters = {"SFZ_Vega"}
	local match6characters = {"SFZ_Balrog", "SFZ_Dhalsim", "SFZ_Honda"}
    local match7characters = {"SFZ_ChunLi-X", "SFZ_Guile", "SFZ_Rose"}
    local match8characters = {"SFZ_R-Charlie"}	
	--local match9characters = {"SFZ_Juni", "SFZ_Juli"}
	local match10characters = {"SFZ_N-Bison"}

	launchStoryboard('data/Intros/Intro_Cammy.def')
	launchStoryboard('data/Intros/Intro_Cammy2.def')
