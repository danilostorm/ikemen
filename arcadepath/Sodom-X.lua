...
-- SODOM ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Dan", "SFZ_ChunLi-X", "SFZ_Sagat", "SFZ_Adon", "SFZ_Rose", "SFZ_Birdie", "SFZ_Zangief"}
    local match5characters = {"SFZ_Ken"}
	local match6characters = {"SFZ_Sakura", "SFZ_Bison", "SFZ_Gen-X"}
    local match7characters = {"SFZ_FeiLong", "SFZ_DJ", "SFZ_Charlie"}
    local match8characters = {"SFZ_Ryu"}	
	local match9characters = {"SFZ_Cody-X"}
	local match10characters = {"SFZ_Honda"}

	launchStoryboard('data/Intros/Intro_Sodom_X.def')
	launchStoryboard('data/Intros/Intro_Sodom_X2.def')
