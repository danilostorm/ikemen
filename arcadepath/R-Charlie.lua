--------------------------------------------
-- RESURRECTED CHARLIE ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Karin", "SFZ_Mika", "SFZ_Honda", "SFZ_Birdie", "SFZ_FeiLong", "SFZ_DJ", "SFZ_Zangief", "SFZ_Cody-Z", "SFZ_Guy", "SFZ_Sagat", "SFZ_Adon", "SFZ_Akuma"}
    local match5characters = {"SFZ_Rose"}
	local match6characters = {"SFZ_Vega", "SFZ_Cammy"}
    local match7characters = {"SFZ_Gen-X", "SFZ_Balrog"}
    local match8characters = {"SFZ_ChunLi-X"}	
	local match9characters = {"SFZ_Ryu"}
	local match10characters = {"SFZ_Guile"}

	launchStoryboard('data/Intros/Intro_R-Charlie.def')
	launchStoryboard('data/Intros/Intro_R-Charlie2.def')
