...
-- DJ ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Sakura", "SFZ_ChunLi-X", "SFZ_Bison", "SFZ_Zangief", "SFZ_T-Hawk", "SFZ_Birdie", "SFZ_Ryu", "SFZ_FeiLong", "SFZ_Balrog"}
    local match5characters = {"SFZ_Adon"}
	local match6characters = {"SFZ_Cody-X", "SFZ_Guy", "SFZ_Blanka"}
    local match7characters = {"SFZ_Honda", "SFZ_Karin", "SFZ_Dan", "SFZ_Sodom-Z"}
    local match8characters = {"SFZ_Gen-X"}	
	local match9characters = {"SFZ_Mika"}
	local match10characters = {"SFZ_Sagat"}

	launchStoryboard('data/Intros/Intro_DJ.def')
	launchStoryboard('data/Intros/Intro_DJ2.def')
