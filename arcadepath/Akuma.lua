...
-- AKUMA ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Birdie", "SFZ_Charlie", "SFZ_Dan", "SFZ_Rolento", "SFZ_Zangief", "SFZ_Ken"}
    local match5characters = {"SFZ_Adon"}
	local match6characters = {"SFZ_Rose", "SFZ_Guy", "SFZ_Sodom-Z", "SFZ_Dhalsim"}
    local match7characters = {"SFZ_ChunLi-Z", "SFZ_Sagat", "SFZ_Sakura"}
    local match8characters = {"SFZ_Ryu"}	
	local match9characters = {"SFZ_Gen-Z"}
	local match10characters = {"SFZ_Bison"}

	launchStoryboard('data/Intros/Intro_Akuma.def')
	launchStoryboard('data/Intros/Intro_Akuma2.def')
