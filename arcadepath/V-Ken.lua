--------------------------------------------
-- VIOLENT KEN ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Gen-X", "SFZ_Charlie", "SFZ_Birdie", "SFZ_Vega", "SFZ_Zangief", "SFZ_Dan", "SFZ_Sagat", "SFZ_Balrog", "SFZ_Rose", "SFZ_DJ"}
    local match5characters = {"SFZ_Dhalsim"}
	local match6characters = {"SFZ_ChunLi-X", "SFZ_Blanka", "SFZ_Guy", "SFZ_Sodom-X"}
    local match7characters = {"SFZ_D-Sakura"}
    local match8characters = {"SFZ_Cammy"}	
	local match9characters = {"SFZ_Ryu"}
	local match10characters = {"SFZ_N-Bison"}

	launchStoryboard('data/Intros/Intro_V-Ken.def')
	launchStoryboard('data/Intros/Intro_V-Ken2.def')
...
if matchno() == 5 then
    ...
    local ok = launchFight{
        ...
        p2numchars = 1,
        p2teammode = "single",
		stage = "stages/_Boss-Dhalsim2.def"
    }
