...
-- SODOM ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Dan", "SFZ_ChunLi-Z", "SFZ_Sagat", "SFZ_Adon", "SFZ_Rose", "SFZ_Birdie", "SFZ_Zangief"}
    local match5characters = {"SFZ_Ken"}
	local match6characters = {"SFZ_Sakura", "SFZ_Bison", "SFZ_Gen-Z"}
    local match7characters = {"SFZ_FeiLong", "SFZ_DJ", "SFZ_Charlie"}
    local match8characters = {"SFZ_Ryu"}	
	local match9characters = {"SFZ_Cody-Z"}
	local match10characters = {"SFZ_Honda"}

	launchStoryboard('data/Intros/Intro_Sodom_Z.def')
	launchStoryboard('data/Intros/Intro_Sodom_Z2.def')
