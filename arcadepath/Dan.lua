...
-- DAN ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Dhalsim", "SFZ_Charlie", "SFZ_Zangief", "SFZ_Rose", "SFZ_Bison", "SFZ_Kbee"}
    local match5characters = {"SFZ_Ken"}
	local match6characters = {"SFZ_Birdie", "SFZ_Adon", "SFZ_ChunLi-Z"}
    local match7characters = {"SFZ_Gen-Z", "SFZ_Sakura", "SFZ_Sodom-Z", "SFZ_Rolento"}
    local match8characters = {"SFZ_Guy"}	
	local match9characters = {"SFZ_Blanka"}
	local match10characters = {"SFZ_Sagat"}

	launchStoryboard('data/Intros/Intro_Dan.def')
	launchStoryboard('data/Intros/Intro_Dan2.def')
