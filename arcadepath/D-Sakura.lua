--------------------------------------------
-- DARK SAKURA ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Adon", "SFZ_Zangief", "SFZ_KBee", "SFZ_Charlie", "SFZ_Dhalsim", "SFZ_Bison", "SFZ_Guy", "SFZ_Birdie", "SFZ_Rolento"}
    local match5characters = {"SFZ_Karin"}
	local match6characters = {"SFZ_Dan", "SFZ_Charlie", "SFZ_Rose"}
    local match7characters = {"SFZ_Honda", "SFZ_Blanka", "SFZ_T-Hawk"}
    local match8characters = {"SFZ_V-Ken"}	
	local match9characters = {"SFZ_Sagat"}
	local match10characters = {"SFZ_Akuma"}

	launchStoryboard('data/Intros/Intro_D-Sakura.def')
	launchStoryboard('data/Intros/Intro_D-Sakura2.def')
