...
-- ADON ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Dhalsim", "SFZ_Bison", "SFZ_Zangief", "SFZ_Charlie", "SFZ_Sakura", "SFZ_Sodom-Z", "SFZ_Kbee"}
    local match5characters = {"SFZ_Ken"}
	local match6characters = {"SFZ_ChunLi-Z", "SFZ_Dan", "SFZ_Mike", "SFZ_Rolento", "SFZ_Rose"}
    local match7characters = {"SFZ_Birdie"}
    local match8characters = {"SFZ_Gen-Z"}	
	local match9characters = {"SFZ_Ryu"}
	local match10characters = {"SFZ_U-Sagat"}

	launchStoryboard('data/Intros/Intro_Adon.def')
	launchStoryboard('data/Intros/Intro_Adon2.def')
