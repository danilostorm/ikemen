...
-- HONDA ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Sakura", "SFZ_DJ", "SFZ_Dan", "SFZ_Ken", "SFZ_Bison", "SFZ_Birdie", "SFZ_Balrog", "SFZ_Dhalsim"}
    local match5characters = {"SFZ_Mika"}
	local match6characters = {"SFZ_Guile", "SFZ_T-Hawk", "SFZ_Karin"}
    local match7characters = {"SFZ_Guy", "SFZ_Rolento", "SFZ_Gen-X"}
    local match8characters = {"SFZ_Cody-Z"}	
	local match9characters = {"SFZ_Ryu"}
	local match10characters = {"SFZ_Zangief"}

	launchStoryboard('data/Intros/Intro_Honda.def')
	launchStoryboard('data/Intros/Intro_Honda2.def')
