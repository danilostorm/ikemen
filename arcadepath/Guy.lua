...
-- GUY ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Sakura", "SFZ_Birdie", "SFZ_ChunLi-Z", "SFZ_Dhalsim", "SFZ_Sagat", "SFZ_Rose", "SFZ_Adon", "SFZ_Dan"}
    local match5characters = {"SFZ_Honda"}
	local match6characters = {"SFZ_Cody-Z"}
    local match7characters = {"SFZ_Zangief", "SFZ_Ken", "SFZ_Ryu", "SFZ_Gen-Z"}
    local match8characters = {"SFZ_Bison"}	
	local match9characters = {"SFZ_Sodom-X"}
	local match10characters = {"SFZ_Rolento"}

	launchStoryboard('data/Intros/Intro_Guy.def')
	launchStoryboard('data/Intros/Intro_Guy2.def')
...
if matchno() == 10 then
    ...
    local ok = launchFight{
        ...
        p2numchars = 1,
        p2teammode = "single",
		stage = "stages/_Boss-Rolento2.def"
    }
