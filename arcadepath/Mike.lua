...
-- BALROG ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_DJ", "SFZ_Rolento", "SFZ_Zangief", "SFZ_Cody-Z", "SFZ_Guy", "SFZ_Charlie", "SFZ_FeiLong", "SFZ_Dhalsim"}
    local match5characters = {"SFZ_Birdie"}
	local match6characters = {"SFZ_Ryu", "SFZ_Ken", "SFZ_Akuma"}
    local match7characters = {"SFZ_ChunLi-X"}
    local match8characters = {"SFZ_Adon"}	
	local match9characters = {"SFZ_U-Sagat"}
	local match10characters = {"SFZ_Bison"}

	launchStoryboard('data/Intros/Intro_Mike.def')
	launchStoryboard('data/Intros/Intro_Mike2.def')
