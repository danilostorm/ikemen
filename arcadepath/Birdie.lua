...
-- BIRDIE ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Ken", "SFZ_Akuma", "SFZ_Guy", "SFZ_Rose", "SFZ_ChunLi-Z", "SFZ_Sakura", "SFZ_Charlie", "SFZ_Zangief"}
    local match5characters = {"SFZ_Dhalsim"}
	local match6characters = {"SFZ_Mike"}
    local match7characters = {"SFZ_Gen-Z"}
    local match8characters = {"SFZ_Adon"}	
	local match9characters = {"SFZ_Sagat"}
	local match10characters = {"SFZ_Bison"}

	launchStoryboard('data/Intros/Intro_Birdie.def')
	launchStoryboard('data/Intros/Intro_Birdie2.def')
