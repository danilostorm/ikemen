...
-- SAKURA ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Adon", "SFZ_Zangief", "SFZ_Charlie", "SFZ_Bison", "SFZ_Guy", "SFZ_Birdie"}
    local match5characters = {"SFZ_Sagat"}
	local match6characters = {"SFZ_Dhalsim", "SFZ_Dan", "SFZ_Ken", "SFZ_Akuma"}
    local match7characters = {"SFZ_Kbee", "SFZ_Rolento", "SFZ_Sodom-Z", "SFZ_Rose"}
    local match8characters = {"SFZ_ChunLi-Z"}	
	local match9characters = {"SFZ_Honda"}
	local match10characters = {"SFZ_Ryu"}

	launchStoryboard('data/Intros/Intro_Sakura.def')
	launchStoryboard('data/Intros/Intro_Sakura2.def')
