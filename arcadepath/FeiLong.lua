...
-- FEILONG ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Vega", "SFZ_Mika", "SFZ_Dhalsim", "SFZ_Zangief", "SFZ_Birdie", "SFZ_Guile", "SFZ_Sakura", "SFZ_Ken", "SFZ_Ryu"}
    local match5characters = {"SFZ_Balrog"}
	local match6characters = {"SFZ_Bison", "SFZ_ChunLi-X", "SFZ_Blanka"}
    local match7characters = {"SFZ_Guy", "SFZ_DJ", "SFZ_Gen-X"}
    local match8characters = {"SFZ_Honda"}	
	local match9characters = {"SFZ_Adon"}
	local match10characters = {"SFZ_Rose"}

	launchStoryboard('data/Intros/Intro_FeiLong.def')
	launchStoryboard('data/Intros/Intro_FeiLong2.def')
