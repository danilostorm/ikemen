--------------------------------------------
-- EVIL RYU ARCADE PATH
--------------------------------------------
    local match1234characters = {"SFZ_Dan", "SFZ_Honda", "SFZ_Karin", "SFZ_Sodom-X", "SFZ_Cody-X", "SFZ_Rolento", "SFZ_Rose", "SFZ_Blanka", "SFZ_Zangief", "SFZ_Charlie"}
    local match5characters = {"SFZ_Sagat"}
	local match6characters = {"SFZ_Birdie", "SFZ_Sakura", "SFZ_Dhalsim"}
    local match7characters = {"SFZ_ChunLi-X", "SFZ_Cammy", "SFZ_Guile"}
    local match8characters = {"SFZ_Gen-X"}	
	local match9characters = {"SFZ_Ken"}
	local match10characters = {"SFZ_AkumaS"}

	launchStoryboard('data/Intros/Intro_E-Ryu.def')
	launchStoryboard('data/Intros/Intro_E-Ryu2.def')
